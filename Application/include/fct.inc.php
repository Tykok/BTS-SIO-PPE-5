...
/**
 * transformDate permet la transformation du champ mois (ex: 201909) en date plus lisible (Septembre - 2019)
 * @param  string $date Reçoit le champ mois à modifier
 * @return string     Retourne la date sous un format plus lisible
 */
...
if($date[4] == 0){
  ...
  $placeMois = $date[4] + $date[5];
}

	 return $lesMois[$placeMois] . " - " . substr($date, 0, 4);
}
